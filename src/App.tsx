...
const JSON_LD = JSON.stringify({
  ...
  '@graph': [
    { '@type': 'WebSite', name: 'PUTIN PUMP', alternateName: '$PUTINPUMP', url: `${SITE}/` },
    {
      ...
      sameAs: [LINKS.x, LINKS.telegram, LINKS.telegramChat],
    },
    {
      '@type': 'FAQPage',
    ...
    <>
        ...
        <header className="hero" id="top" onPointerMove={parallax}>
          ...
          <div className="hero-actions">
            ...
            <div className="social-row">
              <a href={LINKS.x} {...social}><Icon name="x" />X (Twitter)</a>
              <a href={LINKS.telegram} {...social}><Icon name="telegram" />Channel</a>
              <a href={LINKS.telegramChat} {...social}><Icon name="telegram" />Chat</a>
            </div>
          </div>
          <div className="orb">
            <div className="glow" />
      ...
      <main>
        ...
        <section className="community">
          ...
          <div className="cta-row">
            <a className="btn btn-white" href={LINKS.x} {...social}><Icon name="x" />Follow on X</a>
            <a className="btn btn-white" href={LINKS.telegram} {...social}><Icon name="telegram" />Telegram channel</a>
            <a className="btn btn-white" href={LINKS.telegramChat} {...social}><Icon name="telegram" />Telegram chat</a>
            <a className="btn btn-green" href={buyUrl} {...external}>Buy $PUTINPUMP</a>
          </div>
        </section>
      </main>
